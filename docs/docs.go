    ...
    "paths": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "USD",
                        "description": "Currency for generated debts",
                        "name": "currency",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/debts/settle": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Settle debts payload",
                        "name": "settle",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.SettleDebtsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.SettleDebtsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/debts/settlements/{id}/reverse": {
            "post": {
                "produces": [
                    "application/json"
                ],
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "and",
                        "description": "Tag operation: and/or",
                        "name": "op",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "USD",
                        "description": "Currency for generated stats",
                        "name": "currency",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.UserStatsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
